...
export class EnvelopesComponent implements OnInit {
  ...
  currency = "EUR";
  addExpenseTxt = "envelopesAddExpense";
  addEnvelopeTxt = "envelopesAddEnvelope";
  envelopestt2 = "envelopestt2";
	envelopestt3 = "envelopestt3";
	envelopesFutureErr = "envelopesFutureErr";
	envelopesCategory = "envelopesCategory";
	envelopesSelCat = "envelopesSelCat";
	envelopesMake = "envelopesMake";
	envelopesAmount = "envelopesAmount";
	envelopesColor = "envelopesColor";
	envelopesAdd = "envelopesAdd";
	envelopesRec = "envelopesRec";
  envelopesDate = "envelopesDate";
  HINT = "HINT";

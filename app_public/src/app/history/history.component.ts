...
/*
  $(document).ready(function() {
    ...
    $('input[name="daterange"]').daterangepicker({
        ...
        var ddStart = dateStart[0];
        var mmStart = dateStart[1];
        var yyyyStart = dateStart[2];

        var ddEnd = dateEnd[0];
        var mmEnd = dateEnd[1];
        var yyyyEnd = dateEnd[2];
        ...
        for (var i = 0; i < tr.length; i++) {
            ...
            var txtValue = td.innerText.split("\n");
            var ddCheck = txtValue[2];
            var mmCheck = txtValue[1];
            var yyyyCheck = txtValue[0];
            var rez = 0;

            if (mmCheck == 'JAN') rez = 1;
            else if (mmCheck == 'FEB') rez = 2;
            else if (mmCheck == 'MAR') rez = 3;
            else if (mmCheck == 'APR') rez = 4;
            else if (mmCheck == 'MAY') rez = 5;
            else if (mmCheck == 'JUN') rez = 6;
            else if (mmCheck == 'JUL') rez = 7;
            else if (mmCheck == 'AUG') rez = 8;
            else if (mmCheck == 'SEP') rez = 9;
            else if (mmCheck == 'OCT') rez = 10;
            else if (mmCheck == 'NOV') rez = 11;
            else if (mmCheck == 'DEC') rez = 12;

            if (yyyyCheck < yyyyStart || yyyyCheck > yyyyEnd) {
                tr[i].style.display = "none";
            } else if (yyyyCheck == yyyyStart && rez < mmStart) {
                tr[i].style.display = "none";
            } else if (yyyyCheck == yyyyStart && rez == mmStart && ddCheck < ddStart) {
                tr[i].style.display = "none";
            } else if (yyyyCheck == yyyyEnd && rez > mmEnd) {
                tr[i].style.display = "none";
            } else if (yyyyCheck == yyyyEnd && rez == mmEnd && ddCheck > ddEnd) {
                tr[i].style.display = "none";
            } else {
                tr[i].style.display = "";
            }
